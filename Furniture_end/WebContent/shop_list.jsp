        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            ...
            <div class="toolbar">
              <div class="view-mode">
                <ul>
                  <li> <a href="shop_grid.jsp"> <i class="fa fa-th"></i> </a> </li>
                  <li class="active"> <a href="shop_list.jsp"> <i class="fa fa-th-list"></i> </a> </li>
                </ul>
              </div>
              <div class="sorter">
            ...
            <div class="product-list-area">
              <ul class="products-list" id="products-list">
               ...
               <c:forEach items="${productList_2 }" var="pro">
	                <li class="item ">
	                  <div class="product-img">
	                    <div class="icon-sale-label sale-left">热销</div>
	                    <a href="${pageContext.request.contextPath }/single_product?pid=${pro.pid}" title="Ipsums Dolors Untra">
	                    <figure> <img class="small-image" src="${pageContext.request.contextPath }/${pro.pimage}" alt="Ipsums Dolors Untra"></figure>
	                    </a> </div>
	                  <div class="product-shop">
	                    <h2 class="product-name"><a href="single_product.html" title="Ipsums Dolors Untra">${pro.pname }</a></h2>
	                    <div class="ratings">
	                    ...
	                    <div class="price-box">
	                      <p class="special-price"> <span class="price-label"></span> <span class="price"> ￥${pro.pprice } </span> </p>
	                      <p class="old-price"> <span class="price-label"></span> <span class="price"> ￥442.99 </span> </p>
	                    </div>
	                    <div class="desc std">
	                      <p>${pro.pdesc }. <a class="link-learn" title="Learn More" href="single_product.html">了解更多</a> </p>
	                    </div>
	                    <div class="actions">
	                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-cart"></i><span>加入购物车</span></button>
	                      <ul>
