          ...
          <div class="shop-inner">
            ...
            <div class="pagination-area ">
              <ul>
             	...
             	<c:if test="${pageBean.currentPage!=page }">
             		<!-- 带两个参数，全部默认为null传递  -->
             		<li><a href="${pageContext.request.contextPath }/product?method=highProduct&currentPage=${page}&currentCount=${pageBean.currentCount}">${page}</a></li>
             	</c:if>
                ...
                <c:if test="${pageBean.currentPage!=pageBean.totalPage }">
                	<li><a href="${pageContext.request.contextPath }/product?method=highProduct?currentPage=${pageBean.currentPage+1}&currentCount=${pageBean.currentCount}"><i class="fa fa-angle-right"></i></a></li> 
                </c:if>
